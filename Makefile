...
INCLUDE_PATH = -I. -Iddos -Iresults -Izombie
...
OBJS = $O/ddos/TribeFloodNetwork.o $O/zombie/ZombieClient.o
...
depend:
	...
	$(Q)$(MAKEDEPEND) $(INCLUDE_PATH) -f Makefile -P\$$O/ -- $(MSG_CC_FILES)  ./*.cc ddos/*.cc results/*.cc zombie/*.cc
